...
% -- Per-grant custom definitions; shared with nih-r01.sty --
\usepackage{custom-defns}
...
% TODO: Closing impact statement (one bold sentence) summarizing what the
%   aims together will produce.
\textbf{\lipsum[18][1-2]}
